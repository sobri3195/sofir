...
class North_Categories extends BaseWidget {
    public function get_name() {
        return 'sofir-north-categories';
    }

    public function get_title() {
        return \esc_html__( 'North Commerce Categories', 'sofir' );
    }
    ...
    protected function render() {
        ...
        echo '<div class="sofir-north-categories" style="display: grid; grid-template-columns: repeat(' . esc_attr( $columns ) . ', 1fr); gap: ' . esc_attr( $gap ) . 'px;">';

        foreach ( $categories as $category ) {
            echo '<div class="sofir-north-category">';
